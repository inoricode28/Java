...
public class Ejer29 extends JFrame implements ActionListener {
    ...
    public static void main(String args[]){
        Ejer29 ejer_29 = new Ejer29();
        ejer_29.setBounds(0,0,300,150);
        ejer_29.setVisible(true);
        ejer_29.setResizable(false);
        ejer_29.setLocationRelativeTo(null);
